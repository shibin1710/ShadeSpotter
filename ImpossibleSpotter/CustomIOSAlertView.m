...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        if (i == 0) {
            [closeButton setTitleColor:[UIColor colorWithRed:0 green:0.4 blue:0 alpha:1] forState:UIControlStateNormal];

        } else {
            [closeButton setTitleColor:[UIColor colorWithRed:0.75 green:0 blue:0 alpha:1] forState:UIControlStateNormal];

        }
//        [closeButton setTitleColor:[UIColor colorWithRed:0.2f green:0.2f blue:0.2f alpha:0.5f] forState:UIControlStateHighlighted];
        [closeButton.titleLabel setFont:[UIFont fontWithName:@"Georgia" size:17.0]];
